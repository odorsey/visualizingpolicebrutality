/*$.getScript("d3-min.js", function(){
   ...
   alert("D3-min.js loaded but not necessarily executed.");
...
L.Control.SliderControl = L.Control.extend({
    options: {
        ...
        timeStrLength: 4,  // the size of  yyyy-mm-dd hh:mm:ss - if millis are present this will be larger; change back to 10
        maxValue: -1,
        minValue: 0,
    ...
    extractTimestamp: function(time, options) {
		...
		//removing this removes the timestamp that appears on slide
    },
    ...
    onAdd: function (map) {
        ...
        $(sliderContainer).append('<div id="leaflet-slider" style="width:500px; margin-top: -75px;"><div class="ui-slider-handle"></div><div id="slider-timestamp" style="width:500px; height: 30px; margin-top:11px; padding-top:2px; text-align:center; font-size:2em; background-color: #FFFFFF;"></div></div>');
		...
		//console.log('#slider-timeline');
       // $('#slider-timeline').load('timeline.php');
